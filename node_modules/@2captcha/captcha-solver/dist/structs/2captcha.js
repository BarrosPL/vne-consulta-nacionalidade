...
class Solver {
    ...
    */
    ...
    async altcha(params) {
        params = (0, renameParams_1.default)(params);
        (0, checkCaptchaParams_1.default)(params, "altcha");
        const payload = {
            ...this.defaultPayload,
            ...params,
            method: "altcha",
     ...
     * })
     */
    async binance(params) {
        params = (0, renameParams_1.default)(params);
        (0, checkCaptchaParams_1.default)(params, "binance");
        const payload = {
            ...this.defaultPayload,
            ...params,
            method: "binance",
    ...
    async yidun(params) {
        params = (0, renameParams_1.default)(params);
        (0, checkCaptchaParams_1.default)(params, "yidun");
        const payload = {
            ...this.defaultPayload,
            ...params,
            method: "yidun",
